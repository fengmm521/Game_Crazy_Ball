...
#define AXFLAG_ROTATE		0x0001
#define AXFLAG_SMOOTH		0x0002
#define AXFLAG_FINECOLLISIONS	0x0004

class CRunBox2DAxial : public CRunMvtPhysics
{
...
public:
	...
	void SetPos(LPHO pHo, int x, int y);
	DWORD GetFriction();
	DWORD GetDensity();
...
@interface CRunMvtbox2daxial : CRunMvtBox2D
{
@public
	CRunBox2DAxial* m_object;
}
