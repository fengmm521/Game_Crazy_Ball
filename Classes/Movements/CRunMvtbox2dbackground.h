...
#define BKFLAG_ROTATE		0x0001
#define BKFLAG_SMOOTH		0x0002

class CRunBox2DBackground : public CRunMvtPhysics
{
public:
...
public:
	...
	void SetWorldPosition(LPHO pHo);
	LPRDATABASE GetBase();
...
@interface CRunMvtbox2dbackground : CRunMvtBox2D
{
@public
	CRunBox2DBackground* m_object;
}
