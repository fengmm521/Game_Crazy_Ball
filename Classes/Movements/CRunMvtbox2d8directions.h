...
#define EDFLAG_ROTATE		0x0001
#define EDFLAG_SMOOTH		0x0002
#define EDFLAG_FINECOLLISIONS 0x0004

class CRunBox2D8Directions : public CRunMvtPhysics
{
...
public:
	...
	float Minus(float angle);
    void SetCurrentAngle(LPHO pHo);
...
@interface CRunMvtbox2d8directions : CRunMvtBox2D
{
@public
	CRunBox2D8Directions* m_object;
}
