...
@interface CRunKcBoxB : CRunExtension
{
@public	
    CFontInfo* wFont;
    KcBoxBCData* rData;
...
-(void)DisplayObject:(CRenderer*)renderer withParam1:(CRunApp*)idApp andParam2:(CRect)rc andParam3:(KcBoxBCData*)pc andParam4:(NSString*)pText andParam5:(CFontInfo*)hFnt andParam6:(KcBoxBCData1*)pdata1;
...
@interface KcBoxBCData : NSObject
{
@public
...
@interface KcBoxBCData1 : NSObject
{
@public 
...
@interface KcBoxBCFrameData : CExtStorage
{
@public
