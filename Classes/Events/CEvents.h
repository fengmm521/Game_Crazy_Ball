...
#define	ACTL_STOPLOOP		((15<<16)|65535)
#define	ACT_SETLOOPINDEX	((16<<8)|255)
#define	ACTL_SETLOOPINDEX	((16<<16)|65535)
...
// Hidden
#define EXP_LOOPINDEXBYINDEX    ((66<<8)|255)
#define EXPL_LOOPINDEXBYINDEX   ((66<<16)|65535)
...
#define	CND_EXTCMPVARDBL			(CNDIDX_EXTCMPVARDBL<<8)
#define	CNDL_EXTCMPVARDBL			(CNDIDX_EXTCMPVARDBL<<16)
#define	CNDIDX_EXTCMPVARINT			(-42)
#define	CND_EXTCMPVARINT			(CNDIDX_EXTCMPVARINT<<8)
#define	CNDL_EXTCMPVARINT			(CNDIDX_EXTCMPVARINT<<16)
...
#define	ACTL_EXTSETFLAG				(35<<16)
#define	ACT_EXTCLRFLAG				(36<<8)
#define	ACTL_EXTCLRFLAG				(36<<16)
#define	ACT_EXTCHGFLAG				(37<<8)
#define	ACTL_EXTCHGFLAG				(37<<16)
