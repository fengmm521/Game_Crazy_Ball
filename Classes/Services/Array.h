...
/* TODO: should be in bytes, as you don't know how big
 * the array elements will be (e.g. String has its own SSO
 * and so is currently 32 bytes, which makes an ArrayList<String>
 * absolutely huge.)
 */
